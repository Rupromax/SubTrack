  ...
  <div class="subscription-card group">
    ...
    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
      <div class="flex space-x-2">
        ...
        <button 
          v-if="subscription.website"
          @click="openWebsite"
          class="btn-icon text-green-600 hover:text-green-800 hover:bg-green-50"
          title="訪問網站"
        >
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function openWebsite() {
  if (props.subscription.website) {
    window.open(props.subscription.website, '_blank')
  }
}
